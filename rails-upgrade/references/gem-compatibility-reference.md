...
**When to read this:** Workflow 06's compatibility check returned at least one blocker (a gem with no released version that supports the target Rails). This file is the playbook for resolving those.

For the compatibility check itself, see Workflow 06 (primary: `next_rails` `bundle_report compatibility`; secondary: `workflows/06-check-gem-compatibility-workflow.md`). Don't load this file unless you're already past the check and have blockers to work through.
