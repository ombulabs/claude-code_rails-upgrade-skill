...
For the compatibility check itself, see `SKILL.md` Step 4.5 (primary: `next_rails` `bundle_report compatibility`; secondary: `workflows/05-check-gem-compatibility-workflow.md`). Don't load this file unless you're already past the check and have blockers to work through.
